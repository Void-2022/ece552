...
`endif
    ...
    reg [31:0] o_dmem_wdata_temp;
    always @(posedge i_clk) begin
        if (i_rst) begin
            o_dmem_wdata_temp <= 32'd0;
        end else begin
            o_dmem_wdata_temp <= o_dmem_wdata_ex;
        end
    end
    assign o_dmem_wdata=o_dmem_wdata_temp;
